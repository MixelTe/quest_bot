...
def task6(bot: Bot, user: User):
    ...
    answers = ("6", "шесть", "six")
    ok_phrase = ["Верно!", "Представляете, я тут узнал, что оказывается, крипер раньше был свиньей"]
...
def task7(bot: Bot, user: User):
    ...
    ok_phrase = ["Верно!", "А я тут узнал, что оказывается, раньше в Майнкрафте кровати были только красные."]
