...
Revision ID: dff5cadc7839
Revises: 
Create Date: 2025-09-28 23:43:58.193557
...
def upgrade() -> None:
    ...
    sa.Column('control_chat_id', sa.BigInteger(), nullable=True),
    sa.Column('control_chat_thread_id', sa.Integer(), nullable=True),
    sa.Column('broadcast_chat_id', sa.BigInteger(), nullable=True),
    sa.Column('broadcast_chat_thread_id', sa.Integer(), nullable=True),
    ...
    sa.Column('state_args', sa.String(length=256), nullable=False),
